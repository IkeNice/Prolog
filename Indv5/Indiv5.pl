%пятая идивидуальная
run:- consult('C:/Users/hieut/OneDrive/Документы/Prolog/Indv5/mydata.pl'),
    retractall(village/2),retractall(tech/2),
    retractall(character/3),
    menu.
...
deletevillage:- write('Удалить деревню'),nl,nl,
    ...
    tell('C:/Users/hieut/OneDrive/Документы/Prolog/Indv5/mydata.pl'), listing(village),
...
dbsave:- tell('C:/Users/hieut/OneDrive/Документы/Prolog/Indv5/mydata.pl'), listing(village),listing(tech),listing(character),
